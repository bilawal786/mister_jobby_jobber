...
class JardinageEquipmentSelectionStep extends StatelessWidget {
  const JardinageEquipmentSelectionStep({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final equipmentData = Provider.of<ConstProvider>(context, listen: false);
    final extractEquipments = equipmentData.jardinageEquipmentList;
    return Padding(
