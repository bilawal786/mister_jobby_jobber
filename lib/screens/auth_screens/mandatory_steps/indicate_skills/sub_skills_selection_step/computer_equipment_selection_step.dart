...
class ComputerEquipmentSelectionStep extends StatelessWidget {
  const ComputerEquipmentSelectionStep({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final equipmentData = Provider.of<ConstProvider>(context, listen: false);
    final extractEquipments = equipmentData.computerEquipmentList;
    return Padding(
