...
class CourseSkillsSelectionStepScreen extends StatefulWidget {
  final String mainCategoryId;
  final IndicateSkillsModel mainCategory;
  const CourseSkillsSelectionStepScreen({
    Key? key,
  ...
  @override
  State<CourseSkillsSelectionStepScreen> createState() =>
      _CourseSkillsSelectionStepScreenState();
}

class _CourseSkillsSelectionStepScreenState
    extends State<CourseSkillsSelectionStepScreen> {
  int currentStep = 0;
  @override
                ...
                children: <Widget>[
                  ...
                  ((currentStep == 1) &&
                    ...
                    child: ElevatedButton(
                      ...
                      : const SizedBox(),
                  ((currentStep == 2) && (getList.tempEngagement.isNotEmpty))
                      ? Expanded(
                    child: ElevatedButton(
                      onPressed: details.onStepContinue,
                      style: ElevatedButton.styleFrom(
