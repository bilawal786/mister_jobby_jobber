...
class AnimalEquipmentSelectionStep extends StatelessWidget {
  const AnimalEquipmentSelectionStep({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final equipmentData = Provider.of<ConstProvider>(context, listen: false);
    final extractEquipments = equipmentData.animalEquipmentList;
    return Padding(
