...
//
//     final singleJobModel = singleJobModelFromJson(jsonString);

import 'dart:convert';

SingleJobModel singleJobModelFromJson(String str) => SingleJobModel.fromJson(json.decode(str));

String singleJobModelToJson(SingleJobModel data) => json.encode(data.toJson());
...
class SingleJobModel {
  ...
  factory SingleJobModel.fromJson(Map<String, dynamic> json) => SingleJobModel(
    id: json["id"],
    title: json["title"],
