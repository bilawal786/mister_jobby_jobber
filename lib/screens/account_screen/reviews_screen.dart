...
class _ReviewsScreenState extends State<ReviewsScreen> {
  ...
  Widget build(BuildContext context) {
    final reviewsData = Provider.of<AllReviewsProvider>(context, listen: false);
                          ...
                          children: <Widget>[
                            Column(
                              ...
                              children: <Widget>[
                                RichText(
                                  text: TextSpan(
                                    text: extractData!.rating.toString(),
                                    style:
                        ...
                        children: <Widget>[
                          ListTile(
                            ...
                            title: Column(
                              ...
                              children: [
                                Text(
                                  extractData.reviews[index].name,
                                  style: Theme.of(context).textTheme.bodyMedium,
                                ),
                                Text(
                                  extractData.reviews[index].date,
                              ...
                              children: <Widget>[
                                Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    for (int i = 0;
                                        i < extractData.reviews[index].star;
                                        i++)
                                      const Icon(
                                        Icons.star,
                                        color: Colors.amber,
                                    ...
                                    Text(
                                      '(${extractData.reviews[index].star})',
                                      style:
                          ...
                          Text(
                            extractData.reviews[index].message,
