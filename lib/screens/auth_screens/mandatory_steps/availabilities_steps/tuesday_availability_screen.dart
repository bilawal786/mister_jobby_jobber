...
class TuesdayTimeAvailabilityScreen extends StatelessWidget {
  const TuesdayTimeAvailabilityScreen({Key? key}) : super(key: key);
                ...
                builder: (_, selectedTime, child) => Column(
                  ...
                  children: <Widget>[
                    GroupRadioTile(
                      ...
                      value: 1,
                      groupValue: selectedTime.thursdayValue,
                      onClick: (value) {
                        selectedTime.checkTuesdayValue(value, context);
                      },
                    ),
                    GroupRadioTile(
                      title: "Morning only",
