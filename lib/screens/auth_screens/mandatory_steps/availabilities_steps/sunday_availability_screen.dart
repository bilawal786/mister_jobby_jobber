...
class SundayAvailabilityScreen extends StatelessWidget {
  const SundayAvailabilityScreen({Key? key}) : super(key: key);
                ...
                builder: (_, selectedTime, child) => Column(
                  ...
                  children: <Widget>[
                    GroupRadioTile(
                      ...
                      value: 1,
                      groupValue: selectedTime.sundayValue,
                      onClick: (value) {
                        selectedTime.checkSundayValue(value, context);
                      },
                    ),
                    GroupRadioTile(
                      title: "Morning only",
