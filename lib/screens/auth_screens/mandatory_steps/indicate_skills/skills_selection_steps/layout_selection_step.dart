...
import 'layout_skill_selection_steps/child_skills_screen.dart';
import 'layout_skill_selection_steps/engagements_selection_step.dart';
import 'layout_skill_selection_steps/equipments_selection_step.dart';
import 'layout_skill_selection_steps/experience_diploma_step.dart';

class LayoutSkillSelectionStepScreen extends StatefulWidget {
  final String mainCategoryId;
  final SubCategory subCategory;
  const LayoutSkillSelectionStepScreen({
    Key? key,
  ...
  @override
  State<LayoutSkillSelectionStepScreen> createState() =>
      _LayoutSkillSelectionStepScreenState();
}

class _LayoutSkillSelectionStepScreenState
    extends State<LayoutSkillSelectionStepScreen> {
  int currentStep = 0;
  @override
      ...
      body: Stepper(
        ...
        onStepContinue: () {
          ...
          if (isLastStep) {
            ...
            debugPrint(widget.subCategory.id.toString());
        ...
        controlsBuilder: (context, ControlsDetails details) {
          return Container(
            ...
            child: Row(
              children: <Widget>[
                ((currentStep < 1) && (getList.temp.isNotEmpty))
                    ? Expanded(
  ...
  List<Step> getSteps() => [
        Step(
          ...
          title: const Text(""),
          content: ChildSkillsScreen(skillSubCategory: widget.subCategory),
        ),
        Step(
