...
class _SkillsSelectionScreenState extends State<SkillsSelectionScreen> {
  ...
  void didChangeDependencies() {
    if (isInit) {
      Provider.of<IndicateSkillsProvider>(context).getMainCategories(context);
      Provider.of<JobberCheckSkillsProvider>(context).getCheckSkills(context);
    }
    isInit = false;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: (extractedCheckSkills == null || extractedSkills == null)
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    if (extractedCheckSkills.bricolage != true ||
                        extractedCheckSkills.amenegement != true ||
                        extractedCheckSkills.electric != true ||
                        extractedCheckSkills.renovation != true ||
                        extractedCheckSkills.plumber != true) ...[
                      Padding(
                    ...
                    if (extractedCheckSkills.amenegement != true) ...[
                      Padding(
                        padding: const EdgeInsets.symmetric(
                            vertical: 5, horizontal: 15),
                        child: InkWell(
                            ...
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                  builder: (ctx) => LayoutSkillSelectionStepScreen(
                                    ...
                                    extractedSkills[0].id.toString(),
                                    subCategory:
                                    extractedSkills[0].subCategories[0],
                                  )),
                            );
                          },
                          child: Row(
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.only(left: 20.0),
                                child: Text(
                                  extractedSkills[0].subCategories[0].title,
                    ...
                    if (extractedCheckSkills.electric != true) ...[
                      Padding(
                        padding: const EdgeInsets.symmetric(
                            vertical: 5, horizontal: 15),
                        child: InkWell(
                                      ...
                                      MaterialPageRoute(
                                          builder: (ctx) => LayoutSkillSelectionStepScreen(
                                                mainCategoryId:
                                                    extractedSkills[0].id.toString(),
                                                subCategory:
                                                    extractedSkills[0].subCategories[1],
                                              )),
                                    );
                          },
                          child: Row(
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.only(left: 20.0),
                                child: Text(
                                  extractedSkills[0].subCategories[1].title,
                                  style: Theme.of(context).textTheme.bodyMedium,
                                ),
                              ),
                              const Spacer(),
                    ...
                    if (extractedCheckSkills.renovation != true) ...[
                      Padding(
                        padding: const EdgeInsets.symmetric(
                            vertical: 5, horizontal: 15),
                        child: InkWell(
                            ...
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                  builder: (ctx) => LayoutSkillSelectionStepScreen(
                                    ...
                                    extractedSkills[0].id.toString(),
                                    subCategory:
                                    extractedSkills[0].subCategories[2],
                                  )),
                            );
                          },
                          child: Row(
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.only(left: 20.0),
                                child: Text(
                                  extractedSkills[0].subCategories[2].title,
                                  style: Theme.of(context).textTheme.bodyMedium,
                                ),
                              ),
                              const Spacer(),
                    ...
                    if (extractedCheckSkills.plumber != true) ...[
                      Padding(
                        padding: const EdgeInsets.symmetric(
                            vertical: 5, horizontal: 15),
                        child: InkWell(
                            ...
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                  builder: (ctx) => LayoutSkillSelectionStepScreen(
                                    ...
                                    extractedSkills[0].id.toString(),
                                    subCategory:
                                    extractedSkills[0].subCategories[3],
                                  )),
                            );
                          },
                          child: Row(
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.only(left: 20.0),
                                child: Text(
                                  extractedSkills[0].subCategories[3].title,
                                  style: Theme.of(context).textTheme.bodyMedium,
                                ),
                              ),
                              const Spacer(),
                    ...
                    if (extractedCheckSkills.jardinage != true) ...[
                      ListTile(
                        onTap: () => Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (ctx) =>
                                JardinageSkillsSelectionStepScreen(
                    ...
                    if (extractedCheckSkills.livraison != true) ...[
                      ListTile(
                        onTap: () => Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (ctx) =>
                                LivraisonSkillsSelectionStepScreen(
