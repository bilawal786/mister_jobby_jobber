...
import 'computer_equipment_selection_step.dart';

class ComputerSkillsSelectionStepScreen extends StatefulWidget {
  final String mainCategoryId;
  final IndicateSkillsModel mainCategory;
  const ComputerSkillsSelectionStepScreen({
    Key? key,
  ...
  @override
  State<ComputerSkillsSelectionStepScreen> createState() =>
      _ComputerSkillsSelectionStepScreenState();
}

class _ComputerSkillsSelectionStepScreenState
    extends State<ComputerSkillsSelectionStepScreen> {
  int currentStep = 0;
  @override
  ...
  List<Step> getSteps() => [
    ...
    Step(
      ...
      title: const Text(""),
      content: const ComputerEquipmentSelectionStep(),
    ),
    Step(
