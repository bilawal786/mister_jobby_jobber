...
class LivraisonEquipmentSelectionStep extends StatelessWidget {
  const LivraisonEquipmentSelectionStep({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final equipmentData = Provider.of<ConstProvider>(context, listen: false);
    final extractEquipments = equipmentData.livraisonEquipmentList;
    return Padding(
