...
import 'jardinage_equipment_selection_step.dart';

class JardinageSkillsSelectionStepScreen extends StatefulWidget {
  final String mainCategoryId;
  final IndicateSkillsModel mainCategory;
  const JardinageSkillsSelectionStepScreen({
    Key? key,
  ...
  @override
  State<JardinageSkillsSelectionStepScreen> createState() =>
      _JardinageSkillsSelectionStepScreenState();
}

class _JardinageSkillsSelectionStepScreenState
    extends State<JardinageSkillsSelectionStepScreen> {
  int currentStep = 0;
  @override
  ...
  List<Step> getSteps() => [
        ...
        Step(
          ...
          title: const Text(""),
          content: const JardinageEquipmentSelectionStep(),
        ),
        Step(
