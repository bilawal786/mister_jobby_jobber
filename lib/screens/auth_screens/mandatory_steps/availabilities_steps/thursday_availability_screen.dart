...
class ThursdayAvailabilityScreen extends StatelessWidget {
  const ThursdayAvailabilityScreen({Key? key}) : super(key: key);
                ...
                builder: (_, selectedTime, child) => Column(
                  ...
                  children: <Widget>[
                    GroupRadioTile(
                      ...
                      onClick: (value) {
                        selectedTime.checkThursdayValue(value, context);
                      },
                    ),
                    GroupRadioTile(
                      title: "Morning only",
