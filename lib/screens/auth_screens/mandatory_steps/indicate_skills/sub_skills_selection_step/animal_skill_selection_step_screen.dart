...
import 'animal_equipment_selection_step.dart';

class AnimalSkillsSelectionStepScreen extends StatefulWidget {
  final String mainCategoryId;
  final IndicateSkillsModel mainCategory;
  const AnimalSkillsSelectionStepScreen({
    Key? key,
  ...
  @override
  State<AnimalSkillsSelectionStepScreen> createState() =>
      _AnimalSkillsSelectionStepScreenState();
}

class _AnimalSkillsSelectionStepScreenState
    extends State<AnimalSkillsSelectionStepScreen> {
  int currentStep = 0;
  @override
  ...
  List<Step> getSteps() => [
        ...
        Step(
          ...
          title: const Text(""),
          content: const AnimalEquipmentSelectionStep(),
        ),
        Step(
